...
*   [update-routes input](./update-routes-input.md "Route traffic to the given networks through VPN nodes") – `http://schema.nethserver.org/cluster/update-routes-input.json`
