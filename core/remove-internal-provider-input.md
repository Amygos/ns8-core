...
| [designated\_survivor](#designated_survivor) | `string` | Optional | cannot be null | [remove-internal-provider input](remove-internal-provider-input-properties-designated_survivor.md "http://schema.nethserver.org/cluster/remove-internal-provider-input.json#/properties/designated_survivor") |
...
*   defined in: [remove-internal-provider input](remove-internal-provider-input-properties-designated_survivor.md "http://schema.nethserver.org/cluster/remove-internal-provider-input.json#/properties/designated_survivor")
